% pb avec le cheby????
% reprendre pour programmation +elegante...
clear;
close all;
%Nx=128   % Nb d'echantillons par trame (test Vega)
Nx=48     % Nb d'echantillons par trame 
%Nh=3      % Nb de coef IIR => ordre 2
%Nh=5     % Nb de coef FIR => ordre 4
Nh=6     % Nb de coef FIR => ordre 5
%T=5800   % Nb de trames (test Vega)
T=20     % Nb de trames
%T=1
...
% *************************************************************************
% coefficients arrondis avec 5 et 6 chiffres significatifs
...
% Besoin de connaitre les Nh-1 echantillons précedentes de Nh'entrée et 
...
%% *************************************************************************
% FILTRAGE IIR 
% filtre IIR:  Implantation de Nh'equation aux differences 
