...
% T:  nb de trame à générer
% F0:  frequence de la sinusoide  F0<1/2 (freq. normalisée)
% F0 non utilisée qd  'filename' non vide
...
if ~isempty(msg)
   ...
   plot(sig_sin);
    % Conversion du signal en T trames indépendantes
   for j =1:T
