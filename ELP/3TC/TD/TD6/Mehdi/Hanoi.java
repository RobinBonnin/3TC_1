...
public class Hanoi {
   ...
   */
  private static void oneMove(Stack src, Stack dest) throws EmptyStackException {
    dest.push(src.top());
    src.pop();
  }
   ...
   */
  public static void move(Stack src, Stack dest, Stack tmp)throws EmptyStackException{
    oneMove(src, tmp);
    if (!src.empty())
   ...
   * @pre a, b, c are empty
   */
  public static void test(Stack a, Stack b, Stack c) throws EmptyStackException{
  ...
  public static void main(String[] args) {
    ...
    Stack a = new StackByArray();
   // a.pop(); 
    Stack b = new StackByLinkedList();
    Stack c = new StackByArray();
    test(a, b, c);
